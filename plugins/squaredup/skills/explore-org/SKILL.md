...
- **Multiple data sources of the same type.** If there are 3 AWS data sources, "show me EC2 instances" is ambiguous. Either ask the user, or pass all of them as `activePluginConfigIds` to `data_stream_query` and let SquaredUp aggregate.
